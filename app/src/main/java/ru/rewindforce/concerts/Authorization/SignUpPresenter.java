...
public class SignUpPresenter {
    ...
    void signUp(String login, String password, String email, String firstName, String lastName, byte[] imageByteArray) {
        ...
        if(imageByteArray != null) {
            File file = new File(context.getCacheDir(), "tempimage.jpg");
            ...
            avatar = MultipartBody.Part.createFormData("image", file.getName(), reqFile);
        } else {
        ...
        model.onSignUp(partLogin, partPassword, partEmail, partFirstName, partLastName, partCity, avatar,
            ...
            @Override
            public void onSignUp(AuthorizationResponse response) {
                if(fragment != null) fragment.onSignUp(response.getToken(), response.getUid());
            }
